            	...
            	<div class="container-fluid">
            		<div class="row">
            			<div class="col-12">
            				<div class="card">
            					<div class="card-body">
            						<h4 class="card-title">Add Sport Video</h4>
        ...
        ***********************************-->
        ...
        <script type="text/javascript">
        	...
        	function saveTvshow(){
        		...
        		$.ajax({
        			type:'POST',
        			url:'<?php echo base_url(); ?>index.php/admin/updatesportshowclip',
        			data:formData,
        			cache:false,
        			contentType: false,
        			processData: false,
