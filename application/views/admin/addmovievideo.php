            	...
            	<div class="row page-titles mx-0">
            		<div class="col p-md-0">
            			<ol class="breadcrumb">
            				...
            				<li class="breadcrumb-item active"><a href="javascript:void(0)">Add Movie Video</a></li>
            			</ol>
            		</div>
            	</div>
            	<!-- row -->
            	...
            	<div class="container-fluid">
            		<div class="row">
            			<div class="col-12">
            				<div class="card">
            					<div class="card-body">
            						<h4 class="card-title">Add Movie Video</h4>

            						<form id="add_tvshow_form"   onsubmit="saveTvshow();return false;"  
            						enctype="multipart/form-data">

            						<div class="form-group">
            							<label for="input-1">Movie Name</label>
            							<input type="text" required value="" class="form-control" name="episode_title" id="input-1" placeholder="Enter Tv show Name">
            						</div>

                                    <div class="form-group">
                                        <label for="input-2">Movie Category</label>
                                        <!-- DropDown -->
                                 ...
                                 <div class="form-group" >
                                    ...
                                    <input  style="height:100px"; type="text" required value="" class="form-control" name="episode_desc" id="input-1" placeholder="Enter movie Descripation" >
                                </div>
