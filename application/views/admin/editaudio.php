            	...
            	<div class="row page-titles mx-0">
            		<div class="col p-md-0">
            			<ol class="breadcrumb">
            				...
            				<li class="breadcrumb-item active"><a href="javascript:void(0)">Update Audio Clip</a></li>
            			</ol>
            		</div>
            	</div>
            	<!-- row -->
            	...
            	<div class="container-fluid">
            		<div class="row">
            			<div class="col-12">
            				<div class="card">
            					<div class="card-body">
            						<h4 class="card-title">Update Audio Clip</h4>

            						<form id="edit_channel_form" onsubmit="update_channel();"  enctype="multipart/form-data">

            							<div class="form-group">
            								<label for="input-1">Audio Name</label>
            								<input type="text" required value="<?php echo $cid->audio_name; ?>" class="form-control" name="channel_title" id="input-1" placeholder="Enter channel name">
            							</div>

            							<input type="hidden" name="id" value="<?PHP echo $cid->id; ?>">

            							<div class="form-group">
            								<label for="input-1">Audio Descripatiom</label>
            								<textarea  required  class="form-control" name="channel_desc" id="input-1" ><?php echo $cid->audio_desc; ?></textarea> 
            							</div>

            							<div class="form-group" >
            								<label for="input-1">Audio url</label>
            								<input type="text" required value="<?php echo $cid->audio_url; ?>" class="form-control" name="channel_url" id="channel_url" placeholder="Enter channel url">
            							</div>

            							<div class="form-group">
            								<label for="input-1">Audio Image</label>
            								<input type="file" class="form-control" name="channel_thumbnail" id="input-1">
            								<input type="hidden" name="channel_thumbnailimage" value="<?PHP echo $cid->audio_image; ?>">
            								<div><img src="<?php echo base_url().'assets/images/serial/'.$cid->audio_image; ?>" height="100px;" width="100px;"></div>
            							</div>
        ...
        ***********************************-->
        ...
        <script type="text/javascript">
        	...
        	function update_channel(){
        		...
        		$.ajax({
        			type:'POST',
        			url:'<?php echo base_url(); ?>index.php/admin/update_audio',
        			data:formData,
        			cache:false,
        			contentType: false,
        			processData: false,
