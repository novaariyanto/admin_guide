              ...
              <div class="row page-titles mx-0">
                <div class="col p-md-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">TV Show Episode List</a></li>
                  </ol>
                </div>
              </div>
              <!-- row -->
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="table-responsive">
                          ...
                          id="default-datatable" class="table table-bordered">
                          <thead>
                            <tr>
                              <th>Id</th>
                              <th>Image</th>
                          ...
                          <tbody>
                            <?php $i=1;foreach($tvshowepisodelist as $tid){ ?>
                              ...
                              <td><a href="<?php echo base_url()?>index.php/admin/edittvshowepisode?id=<?php echo $tid->tvv_id; ?>">Edit</a> | <a href="javaScript:void(0)" onclick="delete_record('<?php echo $tid->tvv_id; ?>','tvshowepisode')">Delete</a></td>
                            </tr>
                            <?php $i++;} ?>
