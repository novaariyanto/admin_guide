              ...
              <div class="row page-titles mx-0">
                <div class="col p-md-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Sport video list</a></li>
                  </ol>
                </div>
              </div>
              <!-- row -->
                      ...
                      <div class="card-body">
                        ...
                        <tbody>
                         <?php $i=1;foreach($tvshowepisodelist as $tid){ ?>
                          ...
                          <td><a href="<?php echo base_url()?>index.php/admin/editsportshoweclip?id=<?php echo $tid->tvv_id; ?>">Edit</a> | <a href="javaScript:void(0)" onclick="delete_record('<?php echo $tid->tvv_id; ?>','sport')">Delete</a></td>
                        </tr>
                        <?php $i++;} ?>
                      </tbody>
                      <tfoot> 
