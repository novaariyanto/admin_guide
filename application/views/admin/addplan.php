            						...
            						<form id="add_channel_form" onsubmit="saveplan();return false;" enctype="multipart/form-data"> 
            							...
            							<div class="form-row">
            								<div class="form-group col-md-6">
            									...
            									<input name="plan_price" type="number" class="form-control" placeholder="Plan Price">
            								</div>
            								<div class="form-group col-md-6">
            							...
            							<div class="form-row">
            								<div class="form-group col-md-6">
            									...
            									<input name="plan_period" type="number" class="form-control" placeholder="Ex. 1">
            								</div>
            								<div class="form-group col-md-6">
        ...
        ***********************************-->
        ...
        <script type="text/javascript">
        	...
        	function saveplan(){
        		...
        		$.ajax({
        			type:'POST',
        			url:'<?php echo base_url(); ?>index.php/admin/saveplan',
        			data:formData,
        			cache:false,
        			contentType: false,
        			processData: false,
