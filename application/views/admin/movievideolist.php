              ...
              <div class="row page-titles mx-0">
                <div class="col p-md-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Movie Video List</a></li>
                  </ol>
                </div>
              </div>
              <!-- row -->
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">Movie Video List</h4>
                        ...
                        <tbody>
                         <?php $i=1;foreach($tvshowepisodelist as $tid){ ?>
                          ...
                          <td><a href="<?php echo base_url()?>index.php/admin/editmovievideo?id=<?php echo $tid->tvv_id; ?>">Edit</a> | <a href="javaScript:void(0)" onclick="delete_record('<?php echo $tid->tvv_id; ?>','movie')">Delete</a></td>
                        </tr>
                        <?php $i++;} ?>
