            	...
            	<div class="row page-titles mx-0">
            		<div class="col p-md-0">
            			<ol class="breadcrumb">
            				...
            				<li class="breadcrumb-item active"><a href="javascript:void(0)">Add Channel</a></li>
            			</ol>
            		</div>
            	</div>
            	<!-- row -->
            			...
            			<div class="col-12">
            				<div class="card">
            					<div class="card-body">
            						...
            						<form id="add_channel_form" onsubmit="saveChannel();return false;" enctype="multipart/form-data">

            							<div class="form-group">
            								<label for="input-1">Channel Name</label>
            								<input type="text" required value="" class="form-control" name="Channel_title" id="input-1" placeholder="Enter Channel Name">
            							</div>

            							<input type="hidden" name="id" value="">

            							<div class="form-group">
            								<label for="input-3">Channel Descripation</label>
            							...
            							<div class="form-group">
            								<label for="input-1"> Channel thumbnail</label>
            								<input type="text" required  class="form-control" name="channel_thumbnail" id="input-1" placeholder="select Channel image">
    ...
    <!--**********************************
       ...
       <script type="text/javascript">
			...
			function saveChannel(){
				...
				$.ajax({
					type:'POST',
					url:'<?php echo base_url(); ?>index.php/admin/savechannel',
					data:formData,
					cache:false,
					contentType: false,
					processData: false,
