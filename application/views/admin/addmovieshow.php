            	...
            	<div class="row page-titles mx-0">
            		<div class="col p-md-0">
            			<ol class="breadcrumb">
            				...
            				<li class="breadcrumb-item active"><a href="javascript:void(0)">Add Movie Show</a></li>
            			</ol>
            		</div>
            	</div>
            	<!-- row -->
        ...
        ***********************************-->
        ...
        <script type="text/javascript">
        	...
        	function saveTvshow(){
        		...
        		if(tvshow_title==''){
        			toastr.error('Please enter Movie show title','failed');
        			return false;
        		}
        		$("#dvloader").show();
        		...
        		$.ajax({
        			type:'POST',
        			url:'<?php echo base_url(); ?>index.php/admin/addmovieshow_item',
        			data:formData,
        			cache:false,
        			contentType: false,
        			processData: false,
