              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">Audio List Record</h4>
                        ...
                        <tbody>
                         <?php $i=1;foreach($channellist as $channel){ ?>
                          <tr>
                           <td><?php echo $i;?></td>
                           <td><img style="width:100px;height:100px;" src="<?php echo base_url().'/assets/images/serial/'.$channel->audio_image;?>"></td>
                           <td><?php echo $channel->audio_name;?></td>
                           <td><?php echo $channel->audio_url;?></td>
                           <td><?php echo $channel->audio_view;?></td>
                           <td><a href="<?php echo base_url()?>index.php/admin/editaudio?id=<?php echo $channel->id; ?>">Edit</a> | <a href="javaScript:void(0)" onclick="delete_record('<?php echo $channel->id; ?>','audio')">Delete</a></td>
                         </tr>
                         <?php $i++;} ?>
