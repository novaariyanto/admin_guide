            	...
            	<div class="row page-titles mx-0">
            		<div class="col p-md-0">
            			<ol class="breadcrumb">
            				...
            				<li class="breadcrumb-item active"><a href="javascript:void(0)">Add News Clip</a></li>
            			</ol>
            		</div>
            	</div>
            	<!-- row -->
            	...
            	<div class="container-fluid">
            		<div class="row">
            			<div class="col-12">
            				<div class="card">
            					<div class="card-body">
            						<h4 class="card-title">Add News Clip</h4>


            						<form id="add_tvshow_form"   onsubmit="saveTvshow();return false;"  enctype="multipart/form-data">

            							<div class="form-group">
            								<label for="input-1">News Clip Title</label>
            								<input type="text" required value="" class="form-control" name="episode_title" id="input-1" placeholder="Enter News Title">
            							</div>

            							<div class="form-group">
                                            <label for="input-2">News Category</label>
                                            <!-- DropDown -->
            								...
            								<div class="form-group">
            									<label for="input-1">News thumbnail</label>
												<input type="text" class="form-control" name="tvshow_thumbnail" id="input-1" placeholder="link thumbnail" >
            								...
            								<div class="form-group">
												...
												<option value="Link Video">Link Video</option>
												<option value="Link Video">Facebook Video</option>
											...
											<div class="form-group" ><label for="input-1">Episode url</label><input type="text" value="" class="form-control" name="show_url" id="channel_url" placeholder="Enter Server Video URL"></div> 
            									...
            									<!--	<label for="input-1">Upload News Video</label>
            								...
            								<div class="form-group" >
            									<label for="input-1">News Descripation</label>
        ...
        <script type="text/javascript">
        	...
        	function checkVtype(server){
				...
				function saveTvshow(){
					...
					$.ajax({
						type:'POST',
						url:'<?php echo base_url(); ?>index.php/admin/savenewsclip',
						data:formData,
						cache:false,
						contentType: false,
						processData: false,
