				   ...
				   <hr>
				    <form id="category_form"  enctype="multipart/form-data">
					 <div class="form-group">
					  ...
					  <input type="text" name="category_name" class="form-control" id="name" placeholder="Enter Your Category Name">
					 </div>
					 <div class="form-group">
					  <label for="input-2">Category Image</label>
					  <input type="text" name="category_image" class="form-control" id="input-2" >
					 </div>
					 <div class="form-group">
