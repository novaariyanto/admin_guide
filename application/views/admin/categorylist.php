                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <a class="btn btn-sm btn-primary" href="<?php echo base_url()?>index.php/admin/addcategory">Tambah category</a>
                          ...
                          <table class="table table-striped table-bordered zero-configuration">
                           ...
                           <tbody>
                             <?php $i=1;foreach($categorydata as $cat){ ?>
                              <tr>
                                <td><?php echo $i++; ?></td>
                                <td><img src="<?php echo $cat->cat_image; ?>" height="100px;" width="100px;"></td>
                                <td><?php echo $cat->cat_name; ?></td>
                                <td><?php echo $cat->c_date; ?></td>
                                <td><?php echo $cat->c_status; ?></td>
                              </td>
                              <td><a href="<?php echo base_url()?>index.php/admin/editCategory?id=<?php echo $cat->c_id; ?>">Edit</a> | <a href="javaScript:void(0)" onclick="delete_record('<?php echo $cat->c_id; ?>','category')">Delete</a></td>
                            </tr>
                            <?php $i++;} ?>
                          </tbody>
                          <tfoot>
