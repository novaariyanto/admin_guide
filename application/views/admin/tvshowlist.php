              ...
              <div class="row page-titles mx-0">
                <div class="col p-md-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">TV Show List</a></li>
                  </ol>
                </div>
              </div>
              <!-- row -->
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">Tv Show List</h4>
                        <div class="table-responsive">
                          <table class="table table-striped table-bordered zero-configuration">
                           ...
                           <tbody>
                            <?php $i=1;foreach($tvshowlist as $tid){ ?>
                              <tr>
                                <td><?php echo $i; ?></td>
                                <td><img src="<?php echo $tid->tvs_image; ?>" height="100px;" width="100px;"></td>
                                <td><?php echo $tid->tvs_name; ?></td>
                                <td><?php echo $tid->type; ?>
                                <td><?php echo $tid->cat_name; ?></td>
                                <td><?php echo $tid->tvs_view; ?></td>
                                <td><?php echo $tid->tvs_date; ?></td>
                                <td><a href="<?php echo base_url()?>index.php/admin/edittvshow?id=<?php echo $tid->tvs_id; ?>">Edit</a> | <a href="javaScript:void(0)" onclick="delete_record('<?php echo $tid->tvs_id; ?>','tv_serial')">Delete</a></td>
                              </tr>
                              <?php $i++;} ?>
                            </tbody>
                            <tfoot>
