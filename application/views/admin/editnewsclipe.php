            	...
            	<div class="row page-titles mx-0">
            		<div class="col p-md-0">
            			<ol class="breadcrumb">
            				...
            				<li class="breadcrumb-item"><a href="javascript:void(0)">News Show</a></li>
            				<li class="breadcrumb-item active"><a href="javascript:void(0)">Update News Show Clip</a></li>
            			</ol>
            		</div>
            	</div>
            	<!-- row -->
            	...
            	<div class="container-fluid">
            		<div class="row">
            			<div class="col-12">
            				<div class="card">
            					<div class="card-body">
            						<h4 class="card-title">Update News show Clip</h4>
            						...
            						<form id="add_tvshow_form" onsubmit="saveTvshow()"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="input-2">Movie show Category</label>
                                            <!-- DropDown -->
                                            <select name="tvshow_category" required  class="form-control">
                                                <option value="">Select Category</option>
                                                <?php $i=1;
                                                foreach($categorylist as $cat){ ?>
                                                    <option value="<?php echo $cat->c_id; ?>" <?php if($cat->c_id==$vid->fc_id){ echo 'selected="selected"';} ?>><?php echo $cat->cat_name; ?></option>            
                                                    <?php $i++;} ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value="Link Video" <?php if('Server Video'==$vid->tvv_video_type )
        ...
        ***********************************-->
        ...
        <script type="text/javascript">
        	...
        	function saveTvshow(){
        		...
        		$.ajax({
        			type:'POST',
        			url:'<?php echo base_url(); ?>index.php/admin/updatenewsclipe',
        			data:formData,
        			cache:false,
        			contentType: false,
        			processData: false,
